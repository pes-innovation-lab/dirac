...
bool dracon_msgs__msg__job_cost__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dracon_msgs.msg._job_cost.JobCost", full_classname_dest, 33) == 0);
  }
  dracon_msgs__msg__JobCost * ros_message = _ros_message;
  {  // agent_id
...
{
  /* NOTE(esteve): Call constructor of JobCost */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dracon_msgs.msg._job_cost");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JobCost");
