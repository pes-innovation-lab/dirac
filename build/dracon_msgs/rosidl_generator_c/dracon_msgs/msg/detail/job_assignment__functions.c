...
dracon_msgs__msg__JobAssignment__init(dracon_msgs__msg__JobAssignment * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->agent_id)) {
    dracon_msgs__msg__JobAssignment__fini(msg);
    return false;
  }
  // job_id
...
dracon_msgs__msg__JobAssignment__are_equal(const dracon_msgs__msg__JobAssignment * lhs, const dracon_msgs__msg__JobAssignment * rhs)
{
  ...
  // job_x
  if (lhs->job_x != rhs->job_x) {
    return false;
  }
  // job_y
  if (lhs->job_y != rhs->job_y) {
    return false;
  }
  return true;
}
  ...
  dracon_msgs__msg__JobAssignment * output)
{
  ...
  // job_x
  output->job_x = input->job_x;
  // job_y
  output->job_y = input->job_y;
  return true;
}
...
dracon_msgs__msg__JobAssignment__create()
{
  ...
  dracon_msgs__msg__JobAssignment * msg = (dracon_msgs__msg__JobAssignment *)allocator.allocate(sizeof(dracon_msgs__msg__JobAssignment), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dracon_msgs__msg__JobAssignment));
  bool success = dracon_msgs__msg__JobAssignment__init(msg);
  if (!success) {
...
dracon_msgs__msg__JobAssignment__Sequence__init(dracon_msgs__msg__JobAssignment__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dracon_msgs__msg__JobAssignment * data = NULL;

  if (size) {
    data = (dracon_msgs__msg__JobAssignment *)allocator.zero_allocate(size, sizeof(dracon_msgs__msg__JobAssignment), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dracon_msgs__msg__JobAssignment__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dracon_msgs__msg__JobAssignment__fini(&data[i - 1]);
      }
...
dracon_msgs__msg__JobAssignment__Sequence__fini(dracon_msgs__msg__JobAssignment__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dracon_msgs__msg__JobAssignment__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dracon_msgs__msg__JobAssignment__Sequence * array = (dracon_msgs__msg__JobAssignment__Sequence *)allocator.allocate(sizeof(dracon_msgs__msg__JobAssignment__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dracon_msgs__msg__JobAssignment__Sequence__init(array, size);
  if (!success) {
...
dracon_msgs__msg__JobAssignment__Sequence__destroy(dracon_msgs__msg__JobAssignment__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dracon_msgs__msg__JobAssignment__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dracon_msgs__msg__JobAssignment__Sequence__are_equal(const dracon_msgs__msg__JobAssignment__Sequence * lhs, const dracon_msgs__msg__JobAssignment__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dracon_msgs__msg__JobAssignment__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dracon_msgs__msg__JobAssignment__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dracon_msgs__msg__JobAssignment);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dracon_msgs__msg__JobAssignment * data =
      (dracon_msgs__msg__JobAssignment *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dracon_msgs__msg__JobAssignment__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dracon_msgs__msg__JobAssignment__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dracon_msgs__msg__JobAssignment__copy(
