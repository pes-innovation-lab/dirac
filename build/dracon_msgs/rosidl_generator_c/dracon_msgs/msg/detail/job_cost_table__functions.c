...
dracon_msgs__msg__JobCostTable__init(dracon_msgs__msg__JobCostTable * msg)
{
  ...
  // costs
  if (!dracon_msgs__msg__JobCost__Sequence__init(&msg->costs, 0)) {
    dracon_msgs__msg__JobCostTable__fini(msg);
    return false;
  }
  return true;
}
...
dracon_msgs__msg__JobCostTable__fini(dracon_msgs__msg__JobCostTable * msg)
{
  ...
  // costs
  dracon_msgs__msg__JobCost__Sequence__fini(&msg->costs);
}
...
dracon_msgs__msg__JobCostTable__are_equal(const dracon_msgs__msg__JobCostTable * lhs, const dracon_msgs__msg__JobCostTable * rhs)
{
  ...
  // costs
  if (!dracon_msgs__msg__JobCost__Sequence__are_equal(
      &(lhs->costs), &(rhs->costs)))
  {
    return false;
  }
  ...
  dracon_msgs__msg__JobCostTable * output)
{
  ...
  // costs
  if (!dracon_msgs__msg__JobCost__Sequence__copy(
...
dracon_msgs__msg__JobCostTable__create()
{
  ...
  dracon_msgs__msg__JobCostTable * msg = (dracon_msgs__msg__JobCostTable *)allocator.allocate(sizeof(dracon_msgs__msg__JobCostTable), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dracon_msgs__msg__JobCostTable));
  bool success = dracon_msgs__msg__JobCostTable__init(msg);
  if (!success) {
...
dracon_msgs__msg__JobCostTable__Sequence__init(dracon_msgs__msg__JobCostTable__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dracon_msgs__msg__JobCostTable * data = NULL;

  if (size) {
    data = (dracon_msgs__msg__JobCostTable *)allocator.zero_allocate(size, sizeof(dracon_msgs__msg__JobCostTable), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dracon_msgs__msg__JobCostTable__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dracon_msgs__msg__JobCostTable__fini(&data[i - 1]);
      }
...
dracon_msgs__msg__JobCostTable__Sequence__fini(dracon_msgs__msg__JobCostTable__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dracon_msgs__msg__JobCostTable__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dracon_msgs__msg__JobCostTable__Sequence * array = (dracon_msgs__msg__JobCostTable__Sequence *)allocator.allocate(sizeof(dracon_msgs__msg__JobCostTable__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dracon_msgs__msg__JobCostTable__Sequence__init(array, size);
  if (!success) {
...
dracon_msgs__msg__JobCostTable__Sequence__destroy(dracon_msgs__msg__JobCostTable__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dracon_msgs__msg__JobCostTable__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dracon_msgs__msg__JobCostTable__Sequence__are_equal(const dracon_msgs__msg__JobCostTable__Sequence * lhs, const dracon_msgs__msg__JobCostTable__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dracon_msgs__msg__JobCostTable__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dracon_msgs__msg__JobCostTable__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dracon_msgs__msg__JobCostTable);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dracon_msgs__msg__JobCostTable * data =
      (dracon_msgs__msg__JobCostTable *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dracon_msgs__msg__JobCostTable__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dracon_msgs__msg__JobCostTable__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dracon_msgs__msg__JobCostTable__copy(
