...
dracon_msgs__msg__Job__init(dracon_msgs__msg__Job * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->job_id)) {
    dracon_msgs__msg__Job__fini(msg);
    return false;
  }
  // x
  // y
...
dracon_msgs__msg__Job__create()
{
  ...
  dracon_msgs__msg__Job * msg = (dracon_msgs__msg__Job *)allocator.allocate(sizeof(dracon_msgs__msg__Job), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dracon_msgs__msg__Job));
  bool success = dracon_msgs__msg__Job__init(msg);
  if (!success) {
...
dracon_msgs__msg__Job__Sequence__init(dracon_msgs__msg__Job__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dracon_msgs__msg__Job * data = NULL;

  if (size) {
    data = (dracon_msgs__msg__Job *)allocator.zero_allocate(size, sizeof(dracon_msgs__msg__Job), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dracon_msgs__msg__Job__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dracon_msgs__msg__Job__fini(&data[i - 1]);
      }
...
dracon_msgs__msg__Job__Sequence__fini(dracon_msgs__msg__Job__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dracon_msgs__msg__Job__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dracon_msgs__msg__Job__Sequence * array = (dracon_msgs__msg__Job__Sequence *)allocator.allocate(sizeof(dracon_msgs__msg__Job__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dracon_msgs__msg__Job__Sequence__init(array, size);
  if (!success) {
...
dracon_msgs__msg__Job__Sequence__destroy(dracon_msgs__msg__Job__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dracon_msgs__msg__Job__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dracon_msgs__msg__Job__Sequence__are_equal(const dracon_msgs__msg__Job__Sequence * lhs, const dracon_msgs__msg__Job__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dracon_msgs__msg__Job__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dracon_msgs__msg__Job__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dracon_msgs__msg__Job);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dracon_msgs__msg__Job * data =
      (dracon_msgs__msg__Job *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dracon_msgs__msg__Job__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dracon_msgs__msg__Job__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dracon_msgs__msg__Job__copy(
