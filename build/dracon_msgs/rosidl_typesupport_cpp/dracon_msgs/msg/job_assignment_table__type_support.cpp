...
static const _JobAssignmentTable_type_support_symbol_names_t _JobAssignmentTable_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dracon_msgs, msg, JobAssignmentTable)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dracon_msgs, msg, JobAssignmentTable)),
  }
};
...
{
  return &::dracon_msgs::msg::rosidl_typesupport_cpp::JobAssignmentTable_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dracon_msgs, msg, JobAssignmentTable)() {
  return get_message_type_support_handle<dracon_msgs::msg::JobAssignmentTable>();
}
